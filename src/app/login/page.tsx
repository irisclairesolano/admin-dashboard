      ...
      <div className="lg:w-[45%] flex items-center justify-center p-8 lg:p-16 bg-white/40 backdrop-blur-sm relative">
        <div className="max-w-md w-full animate-slide-up">
          <div className="mb-10 text-center lg:text-left">
            <h2 className="font-display text-3xl font-bold text-ink tracking-tight mb-2">Administrator Portal</h2>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="group">
              ...
              <input
                ...
                className="w-full px-5 py-3.5 bg-white rounded-xl border border-ink-faint focus:border-primary/50 outline-none font-body transition-all shadow-sm focus:shadow-md"
